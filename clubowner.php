      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <span class="d-none d-md-block dropdown-toggle ps-2"> <i class="fas fa-user"></i>Club Owner</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="userprofiles/club_owner.php">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content active  " data-bs-parent="#sidebar-nav">
          ...
          <li><a href="mangtrainer.php">Manage Trainer</a></li>
        </ul>
      </li><!-- End Charts Nav -->
    ...
    <div class="pagetitle">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <img class="card-img-top" src="images/assorted-sports-equipment-black-11153245.jpg" alt="" height="260px">
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <img class="card-img-top" src="images/20465779.jpg" alt="">
              <div class="card-body">
                <h3 class="card-title"> <a href="tournamenBooking.php">Tournament Registration</a></h3>
