...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  if(isset($_POST['submit']) && isset($_FILES['image'])){ 
      ...
      move_uploaded_file($file_tmp,"top_players/".$file_name);
      $file_name=$_FILES['image']['name'];
      ...
      $status = $_POST['status'];
      $sql = "INSERT INTO `tplayers` (`player_id`, `player_img`, `player_name`, `player_type`, `game_type`, `address`, `contact`, `email`, `status`) 
      VALUES (NULL, '$file_name', '$player_name', '$player_type', '$game_type', '$address', '$contact', '$email', '$status');";
  ...
  ?>
            ...
            <div class="form-group">
              ...
              <select class="form-select" name="status" id="">
                <option selected value="new">New Player</option>
                <option select value="trained">Trained Player</option>
              </select>
            </div>
            <div class="form-group">
